...
public class scroller : MonoBehaviour
{
    ...
    public GameObject AttachingMovingThing;
    Vector3 initialPosition;
    void Start()
    {
        numLayers = layerFac.Length;
        layers = new Transform[numLayers];
        initialPosition = AttachingMovingThing.transform.position;
    ...
    void Update()
    {
        Vector3 diff = AttachingMovingThing.transform.position - initialPosition;
